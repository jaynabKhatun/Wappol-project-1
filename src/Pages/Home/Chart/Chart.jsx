...
// Component for the chart legend
...
const Chart = () => {
  // State to manage the visibility of the Slider component
  const [showSlider, setShowSlider] = useState(false);

  // Function to handle the click event on the navbar
      ...
      <header className="text-2xl font-bold mt-20">
        <div className="navbar bg-[#F3F3F3] max-w-screen-xl shadow-2xl">
          <div className="flex-1 px-2 lg:flex-none">
            <img className="w-40" src={logo} alt="WPPOOL Logo" />
          </div>
          <div className="flex flex-1 justify-end px-2">
            <div className="flex items-stretch gap-4">
              ...
              <div
                ...
                onClick={handleNavbarClick} // Handle click event to show/hide slider
              >
        ...
        <div className="flex gap-5 max-md:flex-col max-md:gap-0">
          <main className="flex flex-col w-full">
            <section className="flex flex-col mt-1.5 max-md:mt-7 max-md:max-w-full">
              {showSlider ? (
                // Show the Slider component if showSlider is true
                <Slider />
              ) : (
                // Show the chart and related content if showSlider is false
                <>
